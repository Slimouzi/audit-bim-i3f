...
# ``ProjectAddress`` est un type **partagé** (doe + enrichment) → il vit dans
# ``domain/``. Ré-exporté ici pour rétrocompat (``EnrichmentReport.address``,
# ``enrichment.__init__``, imports historiques depuis ``enrichment.models``).
